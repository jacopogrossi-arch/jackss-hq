...
- PDF unico, **A3 orizzontale** 420×297mm, 150–200 dpi
- Nome file: `Cognome_Nome_Brand_Classe.pdf` (es. `Grossi_Jacopo_[Brand]_[Classe].pdf`)
- Numerazione pagine in basso a destra
- Intestazione su ogni tavola: nome, brand scelto, titolo collezione
- Font corpo min 10pt, max 150 parole per le parti descrittive
- Moodboard e stampe originali — no copia-incolla da Pinterest senza rielaborazione
