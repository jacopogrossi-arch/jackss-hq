...
3. **Giacca ussara** *(rivista il 19/09 — coerenza e colore definiti)* — reinterpretata liberamente da Jacopo, non fedele alla struttura storica. Collo ussaro (fedele, non reinterpretato come gli altri colli della collezione). **Aggancio di coerenza al concept**: l'ussaro storico era il cavaliere della sua epoca — comandava un mezzo di movimento veloce (il cavallo) e aveva bisogno di una giacca strutturata ma libera nelle spalle per muoversi in sella; stesso identikit del motociclista Roue Libre (chi comanda un mezzo veloce, eleganza funzionale). **Spalline in stampa 3D**: struttura reticolare/honeycomb rigida — non decorazione ma alleggerimento funzionale (stesso principio della coulisse giacca 1 e delle perforazioni giacca 2: ogni lavorazione risponde a un bisogno). Niente frogging/alamari decorativo sul petto. **Costruzione/aggancio spalline**: non cucite (il materiale rigido stampato si romperebbe con l'ago) — sistema ad aggancio come le spalline militari storiche: passante in tessuto cucito sulla spalla, il pezzo stampato ha una fessura/anello integrato che si infila nel passante, si blocca vicino al colletto con un **bottone a pressione metallico** (stesso hardware ricorrente di giacca 1 e giacca 4 — modulare/removibile, coerente con l'anima "meccanica" della collezione). Manica fluida a frange — l'aria che si muove sul braccio mentre si guida, stesso linguaggio del lino nel concept. **Colore**: azzurro. **Outfit**: pantalone bianco, maglia/maglione beige sotto — palette azzurro/bianco/beige, richiama l'immaginario Costa Azzurra del concept. Tessuto e disegni tecnici ancora da fare.
