...
3. **Field/shirt jacket ibrida** *(nuova idea, 19/09)* — dritta, boxy, lunghezza che scende quasi ai fianchi (via di mezzo tra shirt jacket e field jacket classica). **Tessuto**: lino pesante colore crema, texture materica a vista (slub irregolare/trama grezza). **Collo**: militare aperto (band collar, non chiuso fino alla gola). **Tasche**: oblique/a taglio diagonale, senza patta (rivisto da "a filo nascoste" — nel render risultava troppo piatta/anonima). **Chiusura**: bottoni, con martingala di rinforzo lungo tutta l'abbottonatura. **Stampa 3D** (lavorazione tecnologica assegnata a questa giacca): reticolo/honeycomb stampato in 3D, delicato e tono su tono con il crema (non a contrasto), su due zone — (1) la martingala di rinforzo dell'abbottonatura, (2) rinforzi sui gomiti. Non decorazione ma rinforzo funzionale reale, visibile sia in prompt che negli elaborati fronte/retro (requisito di valutazione: la lavorazione deve essere chiaramente leggibile, non un dettaglio minuscolo). **Aggancio di coerenza al concept**: il lino compare già nel concept ("il lino, leggero, si muove prima ancora che ti muova tu") — qui il lino pesante fa da contrasto funzionale: struttura e protezione quando si è fuori dal mezzo, restando comunque traspirante nel caldo mediterraneo; coerente con l'utility vissuta delle altre giacche (canvas cerato giacca 1, cotone sahariana giacca 2). Colore, tessuto, collo, tasche e le due zone di stampa 3D sono definiti. Sketch tecnico fronte+retro ottenuto il 19/09 via ChatGPT da prompt testuale (figurino base + sketch approvato come riferimento di stile), saltando il passaggio del render fotorealistico Higgsfield — workflow più rapido da iterare quando il design è ancora in movimento. Pronto per il ricalco manuale in Procreate.
