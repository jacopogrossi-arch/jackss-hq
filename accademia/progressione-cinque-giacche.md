# Progressione — Roue Libre (cinque giacche)
...
1. **Quasi-bomber utility** — 🟢 **sketch fronte fatto**
   - Collo: stand collar alto con pattina e bottone a pressione (variante propria, distinta dalla giacca 5) — deciso 17/09, sostituisce l'idea iniziale di collo a imbuto
...
5. [x] **Moodboard tecnica** — completata il 26/09 (`img-cinque-giacche/tavola-moodboard-tecnica-FINALE.png`, con didascalie a mano, nastro rosso tolto). Facoltativo: etichetta "3D print" sul nido d'ape, mappa topografica per giacca 5
