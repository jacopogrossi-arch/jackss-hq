...
**Status: in produzione** — concept definito + trattamento di montaggio dal video di riferimento applicato, immagini/clip ⬜ da generare
...
Questo video ricalca 1:1 un reel di riferimento (brand finto "Jeko", polo verde/bianco modellata su **Polo Ralph Lauren "The Quiet Green"**, ambientazione golf/palme/golden hour, 52s, 9:16, voiceover italiano). Stessa struttura, stesso ritmo — cambiamo solo **brand → Stone Island Ghost Piece** e **ambientazione → industriale urbana**.

**Logica della traduzione:** il riferimento usa l'ambiente nativo del brand (Ralph Lauren = golf/preppy/palme). Noi facciamo lo stesso con Stone Island = industriale/urbano/militare. Il setting industriale già definito nel Brief Lookbook è corretto.
...
- **#1 Brief** (scena 7): documento "creative blueprint" Ghost Piece visibile su ChatGPT/Claude — mostra il brief finito, non la scrittura
- **#2 Generazione** (scena 9): griglia risultati HiggsField Soul ID (4-up), i 5 look che compaiono
- **#3 Montaggio** (scena 16): timeline CapCut con le clip Ghost Piece in sequenza
- (Opzionale, se rafforza: screen rec del moodboard Canva — vedi `assets/video-3-moodboard.md`)

**Scena 2 — B-roll / Seedance (Hook)**
- Usa una delle immagini lookbook Ghost Piece — Jago che cammina/si muove nel cortile industriale
- Seedance 2.0 I2V, ritmo lento
- I Seedance prompts vanno aggiornati al setting industriale Ghost Piece (la sezione sotto descrive ancora i look vecchi)
...
| Immagine vera campagna Stone Island (beat trasparenza) | 15 | ⬜ Da reperire |
...
2. ⬜ **Conferma colore card** — verde militare/olive SI vs nero+ambra Jago
3. ⬜ **Genera immagini lookbook** — HiggsField Soul ID, 5 look Stone Island, ~3-4 varianti per look
