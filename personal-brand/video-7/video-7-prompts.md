...
The graphic treatment evolves following the style of the second attached reference garment: the "JAGO" letters gain a richer weathered treatment — heavier cracking, faint metallic silver-white tonal variation inside the letterforms, edges eroded into the fabric weave. The long under-sleeves carry a dense all-over grunge print in faded white ink — skeletal thorny branches and scattered gothic ornament running down the outer sleeve from shoulder to cuff, heavily washed out, like aged rock-merch printing. The chest of the tee stays otherwise clean — the "JAGO" wordmark is the only chest graphic, all the remaining density lives in the sleeves. No other graphics, no logos, no tags visible.
