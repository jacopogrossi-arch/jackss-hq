...
### Runway 1 — Three-quarter stride, mid-runway (v2 — darker, higher contrast, flash units in frame)
...
The background falls into deep, near-black darkness rather than a lit branding wall — rows of seated audience and press visible only as dark silhouetted shapes lining both sides of the runway, barely lit except where flash spill catches the nearest faces. A photographer crouches at the runway's edge in the near foreground on one side, an external flash unit firing directly toward camera with a hard bright starburst flare, a second and third flash popping from further back in the crowd at staggered distances, all reading as bright anamorphic star-bursts with strong light rays rather than soft diffused bulbs.

High contrast dominates the frame — deep crushed shadow across the background and audience, the model's face, chest lettering, and sleeve graphics lit sharply by the direct flash throw with a hard, punchy, almost harsh key catching the stride mid-motion, strong falloff into shadow along the trailing side of the body, small hard overhead rigging points visible high above rather than a broad even wash, the whole frame reading as stark, high-drama editorial contrast rather than an evenly lit stage.

Captured with a wide-latitude cinema look and a vintage 55mm-equivalent 2x anamorphic character at a wide aperture, pronounced oval bokeh on the dark blurred crowd, strong horizontal anamorphic streak flare bursting off the foreground flash units, color-negative film rendition pushed for contrast with fine theatrical 35mm grain across the entire frame including skin, fabric, and the dark crowd, in an M4 performance register. Real photographic frame captured on a real cinema camera at a real runway show, real fabric, real flash units, real crowd — no CGI, no rendered look, no digital cleanliness, no plastic surfaces, no AI smoothness, no skin smoothing, no flat evenly-lit stage look.
```
...
### Runway 3 — Profile stride, wide runway establishing (v2 — darker, higher contrast, flash units in frame)
...
The composition pulls back wider than a typical close runway shot, showing the full depth of the runway stretching into near-total darkness in the background, dense rows of audience and photographers lining both sides as dark silhouetted shapes in a long unbroken corridor, the far end of the runway and any backdrop dissolving into black well before it can read as a lit branding wall, giving the frame scale through darkness and depth rather than an evenly lit stage.

Photographer flash units fire in a loose scattered rhythm along the full length of the runway corridor, several crouched photographers with visible camera bodies and external flash units close to the runway edge at staggered distances, each flash reading as a bright hard anamorphic star-burst with strong light rays rather than a soft diffused pop, some near and sharp in the foreground, some smaller and dimmer with distance down the dark corridor, no broad overhead wash — only small hard rigging points and the scattered flash bursts providing light.

High contrast dominates the frame — deep crushed shadow across the crowd and background, the model's stride caught in one sharp pool of flash-thrown light with hard falloff into the surrounding dark, the whole frame reading as stark, high-drama editorial contrast rather than a bright evenly lit runway.
