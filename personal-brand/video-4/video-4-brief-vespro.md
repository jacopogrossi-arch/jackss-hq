# Creative Blueprint — VESPRO (Video #4)

> Questo è il **brief creativo** di VESPRO. Doppio uso:
> 1. **Screen rec #1** del video (sc.7) — si registra questo documento a schermo, mostra il brief finito.
> 2. **Base di generazione** — ogni prompt immagine ripete parola per parola i pilastri bloccati qui sotto. La ripetizione è ciò che crea coerenza.
>
> Brand fittizio. Nessun logo reale. Scritto in inglese (è ciò che appare nel video).
