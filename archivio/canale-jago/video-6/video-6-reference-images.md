...
| R3 | **Start frame Shot A** — Talent in camicia bianca, backdrop avorio | Shot A (falso spot): risolve il gap wardrobe (la face lock ha la canotta, lo spot vuole la camicia) + identità per Shot B | ✅ 2 varianti generate 03/07 (NB Pro) — **da scegliere** |
| R4 | **Start frame Shot B** — Talent a x=58%, terzo sinistro vuoto | Shot B (cazzotto): frame di partenza prima dell'ingresso di Jago | ✅ 2 varianti generate 03/07 (NB Pro, agganciate a R3 var. 1) — **da scegliere** |
| R5 | **Start frame Shot C1** — Jago nel soundstage, pugno abbassato | Shot C1 / Shot C 10s: keyframe di partenza dopo il cazzotto | ✅ 2 varianti generate 03/07 (NB Pro, su plate R1 var. 2) — **da scegliere** |
| R6 | **End frame Shot C2** — Jago piantato dietro il worktable | Shot C2 (end frame) + blocking identico a Firma (e alla ex Clip 1) | ✅ 2 varianti generate 03/07 (NB Pro, su plate R2 var. 1) — **da scegliere** |

Identità già disponibili su Magnific:
- **Jago:** character sheet caricato (upload `jago-character-sheet`)
- **Talent:** ✅ risolto 03/07 — `talent-reference.png` (la verticale lockata) ricaricata su Magnific come nuova creation via URL GitHub: https://www.magnific.com/app/creation/Pil0ke742C ⚠️ Nota: l'immagine re-inviata in chat da Jacopo era la variante ORIZZONTALE scartata ("troppo argento") — verificato visivamente e NON usata; il face lock resta la verticale del repo.
...
## R3 — Start frame Shot A (✅ generate, da scegliere)

- Variante 1 (usata come aggancio per R4): https://www.magnific.com/app/creation/DBzuRDQpcl
- Variante 2: https://www.magnific.com/app/creation/Pil0rPv42C

**Modello:** Nano Banana Pro (`imagen-nano-banana-2`), 9:16 2k, reference: face lock Talent (https://www.magnific.com/app/creation/Pil0ke742C).
...
## R4 — Start frame Shot B (✅ generate, da scegliere)

- Variante 1: https://www.magnific.com/app/creation/Pil0Peq42C
- Variante 2: https://www.magnific.com/app/creation/rlQNr25xtc

**Modello:** Nano Banana Pro, 9:16 2k, reference: R3 variante 1 (per camicia + backdrop + identità). Se si sceglie R3 variante 2, rigenerare R4 agganciandolo a quella.
...
## R5 — Start frame Shot C1 (✅ generate, da scegliere)

- Variante 1: https://www.magnific.com/app/creation/jSHiKu9LD0
- Variante 2: https://www.magnific.com/app/creation/Uy1GL5Iwny

**Modello:** Nano Banana Pro, 9:16 2k, reference: character sheet Jago + plate soundstage scelta (R1 variante 2).
...
## R6 — End frame Shot C2 / blocking Firma (✅ generate, da scegliere)

- Variante 1: https://www.magnific.com/app/creation/ohT5eu9829
- Variante 2: https://www.magnific.com/app/creation/tfD1BHomZJ

**Modello:** Nano Banana Pro, 9:16 2k, reference: character sheet Jago + plate atelier scelta (R2 variante 1).
